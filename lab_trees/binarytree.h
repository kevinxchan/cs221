/**
 * @file binarytree.h
 * Declaraction of the BinaryTree class. You will need to modify this
...
class BinaryTree
{
  ...
  private:
     ...
     * Look at the private helpers for height as an example.
     */
    ...
    // TODO ADDED
    void printLeftToRight(Node* root) const;

    void mirror(Node* &root);

    void printPaths(Node* root, string a) const;

    int sumDistances(Node* root, int acc, int h) const;
